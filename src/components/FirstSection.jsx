...
import { BentoGridDemo } from "./AceternityUI/3D-cardEffect/3d-bento";
import { StickyScroll } from "./AceternityUI/3D-cardEffect/sticky-scroll-reveal";
import { TextRevealCardPreview } from "./AceternityUI/3D-cardEffect/3d-text";
  ...
  return (
    <>
      ...
      <div className="overflow-hidden ">
        ...
        <div className="w-auto h-auto  mb-28 bg-black">
          {/* <CardHoverEffectDemo/> */}
          {/* <LampDemo></LampDemo> */}
          {/* <BentoGridDemo /> */}
          {/* grid 4/5/1/2 */}
          ...
          <div className="grid pt-20 gap-4 grid-cols-2 lg:grid-cols-6 px-6 lg:px-12 grid-rows-6 lg:grid-rows-2 overflow-hidden">
            <div
              data-aos="fade-right"
              className="lg:p-14 p-4 flex justify-center items-center  bg-gradient-to-b from-neutral-200 to-neutral-600 rounded-lg  transition ease-in-out delay-150   hover:-translate-y-1 hover:scale-105"
            >
              <FaReact className="text-7xl text-red-600 " />
            </div>
            <div
              data-aos="fade-down"
              className="lg:p-14 flex justify-center items-center bg-gradient-to-b from-neutral-200 to-neutral-600 rounded-lg transition ease-in-out delay-150   hover:-translate-y-1 hover:scale-105"
            >
          ...
          <div className="overflow-hidden">
            <div className="flex justify-center pb-10">
              <div className="text-center py-10">
                <span className=" relative z-10 text-[4rem] md:text-6xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">
            ...
            <div className=" grid lg:grid-cols-2">
              <div
                ...
                data-aos-delay="100"
                className="max-w-md mx-12   bg-gradient-to-b from-neutral-200 to-neutral-600 rounded-xl shadow-md overflow-hidden md:max-w-3xl mb-4"
              >
                <div className="md:flex ">
                  ...
                  <div className="p-8">
                    ...
                    <p className="mt-2 text-white/80 flex">
          ...
          <div className="lg:p-12 p-5 overflow-hidden">
            ...
            >
              <div className="pt-12 relative z-10 text-[4rem] md:text-6xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">
                MY PROJECT
              </div>
              <div className=" min-h-auto mt-12 mb rounded-lg flex text-center justify-center items-center">
                <div className="grid gap-4 mb-24 grid-cols-1 lg:grid-cols-4 px-6 lg:px-12 grid-rows-2 lg:grid-rows-2 ">
                  <div className="lg:p-0 p-4 flex justify-center items-center  ">
                    <button
                      className="btn btn-wide bg-gradient-to-b from-neutral-200 to-neutral-600 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500"
                      onClick={() =>
